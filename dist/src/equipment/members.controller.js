...
let MembersController = class MembersController {
    ...
    findAll(user) { return this.members.findAll(user.bandId); }
    create(user, dto) { return this.members.create(user.bandId, dto); }
    update(user, id, dto) {
        return this.members.update(user.bandId, id, dto);
    }
    remove(user, id) { return this.members.remove(user.bandId, id); }
};
