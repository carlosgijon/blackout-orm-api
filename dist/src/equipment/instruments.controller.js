...
let InstrumentsController = class InstrumentsController {
    ...
    findAll(user) { return this.instruments.findAll(user.bandId); }
    create(user, dto) { return this.instruments.create(user.bandId, dto); }
    update(user, id, dto) {
        return this.instruments.update(user.bandId, id, dto);
    }
    remove(user, id) { return this.instruments.remove(user.bandId, id); }
    setMics(user, id, dto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, String, Object]),
    __metadata("design:returntype", void 0)
], InstrumentsController.prototype, "setMics", null);
